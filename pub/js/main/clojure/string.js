...
{{
var G__5233 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5233;
continue;
}
} else
...
{var pred__5237 = cljs.core._EQ_;var expr__5238 = limit;if(cljs.core.truth_(pred__5237.call(null,1,expr__5238)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5237.call(null,2,expr__5238)))
...
var G__5240 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5241 = (limit__$1 - 1);
var G__5242 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5240;
limit__$1 = G__5241;
parts = G__5242;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5244 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5244))
{var replacement_5245 = temp__4090__auto___5244;buffer.append([cljs.core.str(replacement_5245)].join(''));
} else
{buffer.append(ch);
}
{
